...
# recreate configFile
for (( i = 1 ; i <= 2 ; i++ )) {
  sed -i.org '/IP1=/d' ./configFile-D$i
  sed -i.org '/IP2=/d' ./configFile-D$i
  sed -i.org '/IP3=/d' ./configFile-D$i
  sed -i.org '/IP6=/d' ./configFile-D$i
  sed -i.org '/IP7=/d' ./configFile-D$i
  sed -i.org '/IP8=/d' ./configFile-D$i
  sed -i.org '/IP9=/d' ./configFile-D$i
  sed -i.org '/IP12=/d' ./configFile-D$i
}
...
for (( i = 1 ; i <= 2 ; i++ )) {
  sed -i.org "2s/^/IP1=IPorDNSnameOfNode1${LF}/" ./configFile-D$i
  sed -i.org "3s/^/IP2=IPorDNSnameOfNode2${LF}/" ./configFile-D$i
  sed -i.org "4s/^/IP3=IPorDNSnameOfNode3${LF}/" ./configFile-D$i
  sed -i.org "5s/^/IP6=IPorDNSnameOfNode6${LF}/" ./configFile-D$i
  sed -i.org "6s/^/IP7=IPorDNSnameOfNode7${LF}/" ./configFile-D$i
  sed -i.org "7s/^/IP8=IPorDNSnameOfNode8${LF}/" ./configFile-D$i
  sed -i.org "8s/^/IP9=IPorDNSnameOfNode9${LF}/" ./configFile-D$i
  sed -i.org "9s/^/IP12=IPorDNSnameOfNode12${LF}/" ./configFile-D$i
}
...
for (( i = 1 ; i <= $num_insts ; i++ )) {
  ...
  gcloud compute scp ./configFile-D1 $inst_name:/tmp/configFile-D1 &
  gcloud compute scp ./configFile-D2 $inst_name:/tmp/configFile-D2 &
